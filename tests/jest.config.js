...
module.exports = {
    globals: {
        APP_NAME: 'micro-stream',
        ANT_PREFIX: 'micro-stream-ant',
        ANT_ICON_PREFIX: 'micro-stream-anticon',
    },
    ...
    // cacheDirectory: "C:\\Users\\wang.lianyan\\AppData\\Local\\Temp\\jest",
    ...
    transform: {
        '^.+\\.(js|jsx|mjs|cjs|ts|tsx)$': '<rootDir>/tests/babelTransform.js',
